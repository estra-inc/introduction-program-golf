...
import { GolfCourse } from "@/features/golf-course/types";
...
export default function ClientComponent({ golfCourse }: PageProps) {
  return (
    <>
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="flex flex-col col-span-1">
          <div className="flex flex-col gap-2">
            <h1 className="text-2xl font-bold">{golfCourse.golfCourseName}</h1>
